...
public class FragmentSC extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return (ViewGroup)inflater.inflate(R.layout.fragment_schicksal, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        desc.setText("Substratum For A10, Designed with Modern UI and Anime Style. Include QS Style, Settings, Lockscreen, Volume, etc.");
        btnVariant.setOnClickListener(view1 -> {
            String url = "https://t.me/weeabooify/68";
